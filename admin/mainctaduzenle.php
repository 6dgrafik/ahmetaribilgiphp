        ...
        <form method="post" class="form-row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-9 my-auto">
                    <small>Kısa Açıklama  Yazı Boyutu Girin</small>
                    </div>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="col-12">
                ...
                if($_POST){
                    ...
                    if($sorgu_duzenle -> rowCount()){
                        echo '<div class="alert alert-success">Kayıt Güncellendi</div><meta http-equiv="refresh" content="1; url=maincta.php">';
                    }else{
                        echo '<div class="alert alert-danger">Hata Oluştu</div><meta http-equiv="refresh" content="1; url=maincta.php">';
                    }
