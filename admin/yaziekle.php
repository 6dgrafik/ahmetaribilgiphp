            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <select name="kategori" class="form-control">
                        ...
                        ?>
                                <option value="<?php echo $satir_katlist['kategori']; ?>">
                                <?php echo $satir_katlist['kategori']; ?>
                            </option>
                        <?php
                            }
                        }
                ...
                if($_POST){
                    ...
                    if(move_uploaded_file($_FILES['foto']['tmp_name'],$yuklenecekfoto)){
                        ...
                        if($sorgu_kaydet -> rowCount()){
                            echo '<div class="alert alert-success">Kayıt İşlemi Başarılı</div> <meta http-equiv="refresh" content="1; url=yazilar.php">';
                        }else{
